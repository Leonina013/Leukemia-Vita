# -*- coding: utf-8 -*-
"""Roboflow_TensorFlow_Leukemia_Detection_Notebook.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/github/Leonina013/Leukemia-Vita/blob/main/Roboflow_TensorFlow_Leukemia_Detection_Notebook.ipynb

We will take the following steps to implement Tensorflow (w/ YOLOv4) on our custom leukemia data:
...
test_record_fname = dataset.location + '/test/Cancer-Cells.tfrecord'
train_record_fname = dataset.location + '/train/Cancer-Cells.tfrecord'
label_map_pbtxt_fname = dataset.location + '/train/Cancer-Cells_label_map.pbtxt'
...
> In this section one can specify any model in the [TF2 OD model zoo](https://github.com/tensorflow/models/blob/master/research/object_detection/g3doc/tf2_detection_zoo.md) and set up the training configuration.
...
# %mkdir /content/test/
# %cd /content/test/
!curl -L "https://app.roboflow.com/ds/MeT6yGX24D?key=mLt77FMr7P" > roboflow.zip; unzip roboflow.zip; rm roboflow.zip
